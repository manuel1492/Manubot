...
### `—◉ ⚙️ AJUSTES ⚙️`
- CLONAR EL REPOSITORIO [Aqui](@robledojuan10/fork)
- CAMBIAR NÚMERO DEL OWNER [Aqui](@robledojuan10/blob/master/config.js)
  
### `—◉ 💥 ACTIVAR EN KOYEB 💥`

[![Deploy to Koyeb](https://www.koyeb.com/static/images/deploy/button.svg)](https://app.koyeb.com/deploy?type=git&repository=@robledojuan10&branch=master&name=mysticbot)
...
```bash
git clone @robledojuan10.git && cd TheMystic-Bot-MD
```

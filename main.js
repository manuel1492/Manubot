...
╠══════════════╗
❧ Hola @user,
❧ Te damos la bienvenida a 𝓑𝓲𝓮𝓷𝓿𝓮𝓷𝓲𝓭𝓸/𝓐. 
║
❧ Descubre todo sobre nosotros: 📖
@desc
║
...
// Resto de los mensajes (con emojis y fuente caligráfica)
conn.spromote = '@user ha sido promovido a un rol especial en el grupo. 🚀';

conn.sdemote = '@user ha sido degradado de su rol en el grupo. 😔';

conn.sDesc = `
𝓢𝓔 𝓗𝓐 𝓒𝓐𝓜𝓑𝓘𝓐𝓓𝓞 𝓛𝓐 𝓓𝓔𝓢𝓒𝓡𝓘𝓟𝓒𝓘𝓞𝓝 𝓓𝓔𝓛 𝓖𝓡𝓤𝓟𝓞

Nueva descripción del grupo: @desc`;

conn.sSubject = `
𝓢𝓔 𝓗𝓐 𝓜𝓞𝓓𝓘𝓕𝓘𝓒𝓐𝓓𝓞 𝓔𝓛 𝓝𝓞𝓜𝓑𝓡𝓔 𝓓𝓔𝓛 𝓖𝓡𝓤𝓟𝓞

Nuevo nombre del grupo: @subject`;

conn.sIcon = '¡Hemos cambiado el ícono del grupo! 🌟';

conn.sRevoke = `
𝓢𝓔 𝓗𝓐 𝓐𝓒𝓣𝓤𝓐𝓛𝓘𝓩𝓐𝓓𝓞 𝓔𝓛 𝓛𝓘𝓝𝓚 𝓓𝓔𝓛 𝓖𝓡𝓤𝓟𝓞
...
setInterval(async () => {
  ...
  const bio = `TIEMPO ACTIVO: ${uptime} ┃ sigueme en ig @robledojuan10`;

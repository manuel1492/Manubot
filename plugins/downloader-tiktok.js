...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: '@robledojuan10', body: null, thumbnail: imagen1, sourceUrl: '@robledojuan10'}, mentionedJid: [m.sender]}}}, aa);

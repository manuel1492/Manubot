...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  try {
        ...
        let sistema1 = `Actuaras como un bot de whatsapp creado por Manuel R. , tu seras Manubot, responderas usando el humor y sarcasmo como un mexicano promedio de 20 años.`;
      ...
      try {
        conn.sendPresenceUpdate('composing', m.chat);
        const syms1 = `Actuaras como un bot de whatsapp creado por Manuel R. , tu seras Manubot, responderas usando el humor y sarcasmo como un mexicano promedio de 20 años.`;
